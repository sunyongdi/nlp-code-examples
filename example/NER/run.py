...
from src.easy_bert.NER.tools import train, validate, CustomDataset, preprocess, collate_fn
from src.easy_bert.NER.models.BERT_BiLSTM_CRF import BERT_BiLSTM_CRF
from src.easy_bert.NER.utils.nnUtils import manual_seed
...
def main(cfg):
    ...
    for epoch in range(1, cfg.epoch + 1):
        ...
        train_loss = train(epoch, model, train_dataloader, optimizer, scheduler, device, cfg)
        # 模型验证
        # overall, by_type = validate(args, data, model, id2label, all_ori_tokens)
